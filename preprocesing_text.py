...
nltk.data.path.append('resources/punkt')
nltk.data.path.append('resources/stopwords')
...
txt_stopword = pd.read_csv("data/setting/stopwords.txt", names= ["stopwords"], header = None)
...
normalizad_word = pd.read_excel("data/setting/normalisasi.xlsx")
